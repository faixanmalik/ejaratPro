    ...
    if (req.method == 'POST'){
        ...
        // Receipt Voucher Invoice
            ...
            if( data ){
                ...
                let newEntry = new ChequeTransaction( { totalDebit , totalCredit, inputList, chequeStatus, chequeId, name, dec , memo, journalDate, journalNo, attachment, path } );
