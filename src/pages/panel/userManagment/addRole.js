                              ...
                              <div className="bg-white px-4 py-5 sm:p-6">
                                <div className="grid grid-cols-6 gap-6">
                                    ...
                                    <div className="col-span-6 sm:col-span-2">
                                      <label htmlFor="roleName" className="block text-sm font-medium text-gray-700">{t('roleName')}</label>
                                      <input onChange={handleChange} value={roleName} type="text" name="roleName" id="roleName" className="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required/>
                                    </div>

                                    <div className="col-span-6 sm:col-span-2">
                                      <label htmlFor="roleDesc" className="block text-sm font-medium text-gray-700">{t('roleDesc')}</label>
                                      <input onChange={handleChange} value={roleDesc} type="text" name="roleDesc" id="roleDesc" className="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required/>
                                    </div>
