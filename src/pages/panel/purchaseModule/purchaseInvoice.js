...
import ReactToPrint from 'react-to-print';
  ...
  const PurchaseInvoice = ({ dbVouchers, dbCharts, dbContacts, dbEmployees, dbTaxRate }) => {
    ...
    const submit = async(e)=>{
      ...
      const data = { phoneNo, email, amountPaid, amountReceived, billStatus, city, address, reference, dueDate, inputList, name,  memo, journalDate, billNo, fullAmount, fullTax, totalAmount, attachment, path:'PurchaseInvoice' };
    ...
    const addLines = () => {
      setInputList([...inputList,
        { billNo: billNo, account:'', desc:'', amount:'', taxRate:'', taxAmount:'', totalAmountPerItem:''},
      ])
    }
    ...
    const editEntry = async(id)=>{
      ...
      const data = { id, phoneNo, email, amountPaid, amountReceived, billStatus, city, address, reference, dueDate, inputList, name,  memo, journalDate, billNo, fullAmount, fullTax, totalAmount, attachment, path:'PurchaseInvoice' };
    ...
    const delEntry = async()=>{
      ...
      const data = { selectedIds , path: 'PurchaseInvoice' };
    ...
    const getData = async (id) =>{
      ...
      const data = { id, path: 'PurchaseInvoice' };
      ...
      <div className="md:grid md:grid-cols-1 md:gap-6">
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0 flex">
            <h3 className="text-lg font-semibold leading-6 text-gray-900">Purchase Invoice</h3>
            <button 
              type='button'
              onClick={()=>{
                setOpen(true)
                ...
                <table ref={componentRef} className="w-full text-sm text-left text-gray-500 ">
                  ...
                  <tbody>
                    ...
                    return <tr key={index} className="bg-white border-b hover:bg-gray-50">
                      ...
                      <td className="p-1">
                        <div className='text-sm text-black font-semibold'>{moment(item.journalDate).format('D MMM YYYY')}</div>
                      </td>
                      <td className="p-1">
