...
import useTranslation from 'next-translate/useTranslation';
  ...
  const Expenses = ({ dbVouchers, dbAccounts, dbPaymentType, dbContacts, dbEmployees, dbTaxRate, dbProject }) => {
    ...
    const editEntry = async(id)=>{
      ...
      const data = { id, phoneNo, email, city, paidBy, project, dueDate, inputList, name,  memo, journalDate, journalNo, fullAmount, fullTax, totalAmount, attachment, path:'Expenses' };
                ...
                <table ref={componentRef} className="w-full text-sm text-left text-gray-500 ">
                  ...
                  <tbody>
                    ...
                    return <tr key={index} className="bg-white border-b hover:bg-gray-50">
                      ...
                      <td className="p-1">
                        <div className='text-sm'>{item.paidBy}</div>
                      </td>
                      <td className="p-1">
