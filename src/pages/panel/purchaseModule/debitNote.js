...
import Project from 'models/Project';
  ...
  const DebitNote = ({ dbVouchers, dbCharts, dbContacts, dbEmployees, dbTaxRate, dbProject }) => {
    ...
    const submit = async(e)=>{
      ...
      const data = { phoneNo, email, project, city, address, reference, accuralDate, inputList, name,  memo, journalDate, billNo, fullAmount, fullTax, totalAmount, attachment, path:'DebitNote' };
      ...
      <div className="md:grid md:grid-cols-1 md:gap-6">
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0 flex">
            <h3 className="text-lg font-semibold leading-6 text-gray-900">Debit Note Invoices</h3>
            <button 
              onClick={()=>{
                setOpen(true)
                setId('')
        ...
        <div className="mt-2 md:col-span-2 md:mt-0">
          <div className='flex'>
            ...
            <ReactToPrint
              ...
              documentTitle='Debit Note Invoices'
              pageStyle='print'
            />
          </div>
                      ...
                      <div className="overflow-hidden shadow sm:rounded-md">
                        ...
                        <div className="bg-gray-50 space-x-3 px-4 py-3 text-right sm:px-6">
                          ...
                          <ReactToPrint
                            ...
                            documentTitle='Debit Note Invoice'
                            pageStyle='print'
                          />
